...
#define IsIphone6 (CGRectGetWidth([UIScreen mainScreen].bounds) == 375 ? YES : NO)
#define IsIphone6P (CGRectGetWidth([UIScreen mainScreen].bounds) == 414 ? YES : NO)
#define IsUpIphone5 (CGRectGetHeight([UIScreen mainScreen].bounds) > 568 ? YES : NO)
#define IsUpIphone6 (CGRectGetWidth([UIScreen mainScreen].bounds) > 375 ? YES : NO)
